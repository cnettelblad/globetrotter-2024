...
const { message, type = 'success' } = defineProps<ToastProps>();
...
<template>
    ...
    >
        ...
        <!-- Warning Icon -->
        <div v-if="type == 'warning'" class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-orange-500 bg-orange-100 rounded-lg">
            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
